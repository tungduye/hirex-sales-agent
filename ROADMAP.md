...
- Phase 2B.2 adds explicit Gmail send reconsent, Phase 2B.3 adds a reviewed one-message send service, and Phase 2B.4 adds reply/thread sending derived from trusted mailbox state.
